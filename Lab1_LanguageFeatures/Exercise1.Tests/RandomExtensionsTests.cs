...
{
    [ExerciseTestFixture("dotnetExp", "H1", "Exercise01", @"Exercise1\RandomExtensions.cs;Exercise1\Balloon.cs")]
    public class RandomExtensionsTests
    {
        ...
        public void _05_NextBalloon_GeneratedSizeShouldBeLessThanOrEqualToTheMaximumSize()
        {
            ...
            for (int i = 0; i < numberOfBalloons; i++)
            {
                int maxSize = Random.Shared.Next(1, 4);
        ...
        {
            return (Balloon?)_nextBalloonMethodInfo?.Invoke(null, new object[] { Random.Shared, maxSize });
        }

        private Balloon? InvokeNextBalloonFromArray(Balloon[] balloons)
        {
            return (Balloon?)_nextBalloonFromArrayMethodInfo?.Invoke(null, new object[] { Random.Shared, balloons });
        }
