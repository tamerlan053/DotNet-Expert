...
{
    [ExerciseTestFixture("dotnetExp", "H2-Controls", "Exercise6", @"Exercise6\MainWindow.xaml")]
    ...
    public class MainWindowTests
    {
        ...
        public void Setup()
        {
            ...
            var allCheckBoxes = _window.FindVisualChildren<CheckBox>().ToList();
            if (allCheckBoxes.All(checkBox => checkBox is { Parent: Grid, VerticalAlignment: VerticalAlignment.Top }))
            {
        ...
        {
            var codeBehindFilePath = @"Exercise6\MainWindow.xaml.cs";

            var fileHash = Solution.Current.GetFileHash(codeBehindFilePath);
            Assert.That(fileHash, Is.EqualTo("DD-FD-C5-BA-58-AD-5E-81-65-CA-BE-86-91-37-0A-AA"), () =>
