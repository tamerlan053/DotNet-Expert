...
{
    [ExerciseTestFixture("dotnetExp", "H2-Controls", "Exercise1", @"Exercise1\MainWindow.xaml")]
    ...
    public class MainWindowTests
    {
        ...
        public void Setup()
        {
            ...
            var allButtons = _window.FindVisualChildren<Button>().ToList();
        ...
        public void _3_ShouldHaveAnImageButtonInTheMiddle()
        {
            ...
            Assert.That(imageControl!.Source, Is.Not.Null,
                () =>
                    ...
                    "Make sure the 'Source' url is a valid relative URL (it must start with 'images/', it should NOT start with '/')");
            ...
            Uri? baseUri = bitmapSource switch
            {
                BitmapFrame bitmapFrame => bitmapFrame.BaseUri,
                BitmapImage bitmapImage => bitmapImage.BaseUri,
                _ => null
            };
